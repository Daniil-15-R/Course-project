...
![Снимок экрана 2025-03-29 150906] (https://github.com/user-attachments/assets/)
...
![Снимок экрана 2025-03-29 151701](https://github.com/user-attachments/assets/7b342551-0a8a-4807-9911-2cbcf462ed90)
Причины успешных результатов полное введение корректных данных, что для поля авторизации, что и для поля регистрации
Причины неуспешных результатов введение в некоторых местах некорретных данных
